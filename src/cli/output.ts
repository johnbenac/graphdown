...
const hintMap: Partial<Record<ValidationErrorCode, string>> = {
  ...
  E_GITHUB_URL_INVALID_FORMAT:
    'Supported: github.com/<owner>/<repo> and github.com/<owner>/<repo>/tree/<ref>/<subdir>.',
  E_GITHUB_NOT_FOUND:
    'Check the repo name; if private, provide GITHUB_TOKEN.',
  E_GITHUB_AUTH_REQUIRED:
    'Set GITHUB_TOKEN env var (or make the repo public).',
  ...
  E_GITHUB_FETCH_FAILED:
    'Re-run the command; if persistent, open an issue.',
