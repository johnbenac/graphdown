...
Record→block edges implied by CID references extracted from record body/fields.

- Nodes: records + block CIDs
- Edges: `recordKey -> cid`

Validation requires referenced blocks exist and match CID digests (VAL-BLOCK-001/002).
