...
Record/type → block edges implied by block references extracted from record/type body/fields and plugin manifest `blocks[]`.

- Nodes: records, types, and block CIDs
