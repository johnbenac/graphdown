...
- **UI errors**: update import/error surfaces (`apps/web/src/state/DatasetContext.tsx`, `apps/web/src/import/github/mapGitHubError.ts`) to include any new warning/error codes for unmet type dependencies.
