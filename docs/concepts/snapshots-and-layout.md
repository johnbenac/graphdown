...
Graphdown works with datasets as files. Internally, the dataset layer uses a snapshot abstraction.
...
The Graphdown dataset layer can operate on any snapshot and discovers record files by content (LAYOUT-001).
