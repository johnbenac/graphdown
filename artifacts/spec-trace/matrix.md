...
Generated: 2026-01-14T21:22:37.462Z
...
- packages/core/src/__tests__/spec/hash.plugins.integration.test.ts — "HASH-001: plugin bundle files with broken front matter are hashed"
...
Tests (2):
- packages/core/src/__tests__/spec/plugins.validate.integration.test.ts — "LAYOUT-003: plugin bundle files may contain malformed front matter"
- packages/core/src/__tests__/spec/validateDatasetSnapshot.integration.test.ts — "LAYOUT-003: malformed front matter in non-semantic markdown is ignored"
...
Tests (3):
- packages/core/src/__tests__/spec/validateDatasetSnapshot.integration.test.ts — "FR-MD-023: missing fields in a discovered record fails validation"
