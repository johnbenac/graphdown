...
Tests (3):
- packages/core/src/__tests__/pluginManifest.discovery.test.ts — "PLUG-LAYOUT-001: detects plugin manifest fixtures"
- packages/core/src/__tests__/pluginManifest.discovery.test.ts — "PLUG-LAYOUT-001: record precedence rejects records with typeId"
