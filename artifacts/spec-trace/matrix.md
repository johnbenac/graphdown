...
Generated: 2026-01-14T23:26:59.185Z
...
Tests (5):
- packages/core/src/__tests__/spec/plugins.firstClass.integration.test.ts — "PLUG-000: binary plugin bundle files are validated, hashed, and exported as raw bytes"
...
Tests (2):
- packages/core/src/__tests__/spec/plugins.validate.integration.test.ts — "VAL-PLUG-005: binaryFiles entries allow non-UTF-8 plugin bundle files"
- packages/core/src/__tests__/spec/plugins.validate.integration.test.ts — "VAL-PLUG-005: plugin bundle files must be UTF-8 decodable unless declared binary"
...
- apps/web/src/features/export/__tests__/exportZip.plugins.integration.test.ts — "EXP-PLUG-001: preserves binary plugin bundle files across export/import"
