...
Generated: 2026-01-14T06:27:11.045Z
...
Tests (4):
- packages/core/src/__tests__/pluginManifest.frontMatter.test.ts — "PLUG-FR-001: invalid YAML fails with E_YAML_INVALID"
- packages/core/src/__tests__/pluginManifest.frontMatter.test.ts — "PLUG-FR-001: missing closing delimiter fails with E_FRONT_MATTER_UNTERMINATED"
- packages/core/src/__tests__/pluginManifest.frontMatter.test.ts — "PLUG-FR-001: missing opening delimiter fails with E_FRONT_MATTER_MISSING"
- packages/core/src/__tests__/pluginManifest.frontMatter.test.ts — "PLUG-FR-001: non-object YAML fails with E_YAML_NOT_OBJECT"
...
Tests (3):
- apps/web/src/features/export/__tests__/exportZip.plugins.test.ts — "EXP-006: includes plugin-declared blocks even when records do not reference them"
...
Tests (1):
- apps/web/src/features/export/__tests__/exportZip.plugins.test.ts — "EXP-PLUG-001: exports plugin bundles in canonical layout with exact bytes"
