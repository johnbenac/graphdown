...
Generated: 2026-01-08T03:56:09.365Z
...
Tests (1):
- apps/web/src/graphdown/__tests__/wikiTokens.test.ts — "BLOB-002: blob ids must be 64 lowercase hex characters"
...
Tests (1):
- apps/web/src/graphdown/__tests__/wikiTokens.test.ts — "REL-001: blob references are not treated as record relationships"
...
Tests (2):
- apps/web/src/graphdown/__tests__/wikiTokens.test.ts — "REL-003: extracts record references from wiki-link tokens"
- apps/web/src/graphdown/__tests__/wikiTokens.test.ts — "REL-003: ignores malformed record tokens and aliases"
...
- apps/web/src/graphdown/__tests__/wikiTokens.test.ts — "BLOB-REF-001: extracts blob references"

## BLOB-REF-002 — Blob reference normalization is strict (testable=true)
Tests (1):
- apps/web/src/graphdown/__tests__/wikiTokens.test.ts — "BLOB-REF-002: ignores malformed blob references"
