...
Generated: 2026-01-05T05:23:29.411Z
...
Tests (1):
- apps/web/src/__tests__/core/core.roundtrip.test.ts — "GC-001: reachable blob set includes references from fields"

## GC-002 — Unreferenced blobs are garbage and are excluded from record-only export (testable=true)
Tests (1):
- apps/web/src/__tests__/core/core.roundtrip.test.ts — "GC-002: export excludes unreferenced blobs after canonicalization"
...
Tests (1):
- apps/web/src/__tests__/core/core.roundtrip.test.ts — "EXP-006: record-only export includes reachable blobs"
