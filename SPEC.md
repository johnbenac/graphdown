...
Because block references include the CID digest and block integrity is enforced (VAL-BLOCK-001/VAL-BLOCK-002),
...
The reachable block set is defined as the set of `<cid>` values referenced by block references extracted from all record objects per CID-REF-001/CID-REF-002.
