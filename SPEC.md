...
<!-- req:id=NR-LINK-001 title="No requirement that links resolve (except composition constraints)" -->
...
<!-- req:id=NFR-001 title="CRUD does not perform full document reloads" testable=true -->
