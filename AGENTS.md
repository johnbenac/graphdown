...
- Design systems to fail fast, fail loud, and fail noisy with rich observability; stop and surface issues immediately instead of passing bad work forward or failing quietly/gracefully.
