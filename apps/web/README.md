...
This is the React/Vite frontend for importing, validating, browsing, editing, and exporting Graphdown datasets. It uses the shared core validation library and persists the active dataset in the browser using IndexedDB (required; environments without IndexedDB are unsupported).
...
- `src/__tests__/` fixture data and integration-style tests for the core library.
...
- The app persists state in IndexedDB; environments without IndexedDB will surface a storage-required error.
