...
This is the React/Vite frontend for importing, validating, browsing, editing, and exporting Graphdown datasets. It uses the shared core validation library and persists the active dataset in the browser using IndexedDB (required).
