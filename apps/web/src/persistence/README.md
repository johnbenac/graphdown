...
- `persistence.ts`
  ...
  - Rehydrates the active dataset on load only when snapshot + graph cache + meta are present.
  - Clears the active dataset when required persisted pieces are missing.
