...
Optional keys:
- `meta` (object; opaque to dataset)
- `config` (object; opaque to dataset)
- `requires` (array of strings; opaque to dataset)
- `blocks` (array of block CID strings; interpreted by dataset for reachability + validation)
