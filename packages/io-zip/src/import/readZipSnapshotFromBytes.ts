...
import { ImportError, type ImportResult, selectSemanticSnapshotFiles } from "@graphdown/io";
...
export function readZipSnapshotFromBytes(zipBytes: Uint8Array): ImportResult {
  ...
  try {
    ...
    throw new ImportError({ source: "zip", code: "invalid_input", message: `Invalid zip file: ${message}` });
  }
