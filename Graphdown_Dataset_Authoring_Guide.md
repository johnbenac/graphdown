...
> Plugins are authored and exported under `plugins/`.
...
When Graphdown exports a **canonical** dataset zip/snapshot, tools keep plugins in the same `plugins/<pluginId>/` layout.
